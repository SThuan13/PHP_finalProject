  ...
  <main class="main-content position-relative max-height-vh-100 h-vh-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4 position-relative">
      <div class="card p-3">
        ...
        <form 
          action="<?php if(isset($category)) {echo url('admin/category/handleupdate');}  else{echo url('admin/category/handlecreate');}  ?>"  
          method="post"
        >
          ...
          <div class="col-md-6">
            <div class="input-group input-group-static my-3">
              ...
              <input type="text" name="name" class="form-control" 
                <?php if(isset($category)) {?>value="<?php echo $category['name'];?>" <?php }?>
              >
            </div>
          </div>
          <div class="col-md-6">
            <div class="input-group input-group-static my-3">
              ...
              <?php if(isset($category)) {?> 
                value="<?php if(isset($category['description'])){echo $category['description'];} else {echo '';}?>" 
              <?php }?>>
            </div>
          </div>
        </div>
        ...
        <div class="gx-5">
          ...
          <a href="<?php echo url('admin/category/')?>" class="btn btn-outline-secondary">Trở lại</a>
        </div>
