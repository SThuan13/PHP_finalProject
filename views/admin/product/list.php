    ...
    <div class="container-fluid py-4 position-relative">
      ...
      <div class="row">
        ...
        <div class="col-6 col-sm-2">
          <a href="<?php echo url('admin/product/create')?>" class="btn bg-gradient-primary ">Tạo sản phẩm</a>
        </div>
          ...
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-sm">
                  <?php echo $cproduct['description'];?>
                </td>
                <td class="align-middle">
                  <a href="<?php echo url('admin/category/detail', ['id'=>$product['id']])?>" class="text-secondary font-weight-normal text-xs" data-toggle="tooltip">
                    Edit
                  </a>
                </td>
                <!-- <td class="align-middle">
