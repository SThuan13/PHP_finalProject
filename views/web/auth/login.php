        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form role="form" method="POST" action="<?php echo url('auth/handleLogin')?>" class="text-start">
                  ...
                  <p class="mt-4 text-sm text-center">
                    Chưa có tài khoản?
                    <a href="<?php echo url('auth/register')?>" class="text-primary text-gradient font-weight-bold">Đăng ký</a>
                  </p>
                  <p class="mt-4 text-sm text-center"><a href="<?php echo url('auth/reset')?>">Quên mật khẩu</a></p>
                </form>
              </div>
            </div>
          </div>
