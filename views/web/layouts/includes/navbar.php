        ...
        <ul class="navbar-nav navbar-nav-hover ms-auto">
           <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
            <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuPages2" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              Pages
              <img src="<?php echo asset('assets/web/assets/img/down-arrow-white.svg') ?>" alt="down-arrow" class="arrow ms-auto ms-md-2 d-lg-block d-none">
              <img src="<?php echo asset('assets/web/assets/img/down-arrow-dark.svg') ?>" alt="down-arrow" class="arrow ms-auto ms-md-2 d-lg-none d-block">
            </a>
          </li>
          ...
          <li class="nav-item ms-lg-auto my-auto ms-3 ms-lg-0 mt-2 mt-lg-0">
            <a href="<?php echo url('auth/login') ?>" class="btn btn-sm  bg-gradient-primary mb-0 me-1 mt-2 mt-md-0">Đăng nhập</a></li>
            <a href="<?php echo url('auth/register') ?>" class="btn btn-sm  bg-gradient-primary mb-0 me-1 mt-2 mt-md-0">Đăng ký</a></li>
        </ul>
      </div>
    </div>
  </nav>